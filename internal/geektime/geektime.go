...
const (
	...
	// V1MyProductsAllPath get all purchased products
	V1MyProductsAllPath = "/serv/v1/my/products/all"
...
// MyProductsAll get all purchased products
func (c *Client) MyProductsAll() (response.V1MyProductsResponse, error) {
	var res response.V1MyProductsResponse
	r := c.newRequest(
		resty.MethodPost,
		DefaultBaseURL,
		V1MyProductsAllPath,
	...
	if _, err := do(r); err != nil {
		return response.V1MyProductsResponse{}, err
	}
	return res, nil
}

// NewAllColumns get all columns/videos by type (1=column, 3=video)
func (c *Client) NewAllColumns(columnType int) (response.V1ColumnNewAllResponse, error) {
	var res response.V1ColumnNewAllResponse
	r := c.newRequest(
		resty.MethodPost,
		DefaultBaseURL,
		"/serv/v1/column/newAll",
		nil,
	...
	if _, err := do(r); err != nil {
		return response.V1ColumnNewAllResponse{}, err
	}
	return res, nil
}
